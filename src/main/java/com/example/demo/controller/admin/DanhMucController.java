...
public class DanhMucController {
    ...
    @GetMapping("view")
    public String searchDanhMuc(Model model, @RequestParam(defaultValue = "") String search1
        ...
        Page<DanhMuc> listDanhMuc = danhMucRepository.searchDanhMuc(
                search1.trim(), loai1Int, pageable);
        model.addAttribute("danhMucLists", listDanhMuc);
