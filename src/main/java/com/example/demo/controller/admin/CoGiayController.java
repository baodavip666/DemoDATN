...
public class CoGiayController {
    ...
    @GetMapping("view")
    public String searchCoGiay(Model model, @RequestParam(defaultValue = "") String search1
        ...
        Page<CoGiay> listCoGiay = coGiayRepository.searchCoGiay(
                search1.trim(), loai1Int, pageable);
        model.addAttribute("coGiayLists", listCoGiay);
