...
public class DeGiayController {
    ...
    @GetMapping("view")
    public String searchDeGiay(Model model, @RequestParam(defaultValue = "") String search1
        ...
        Page<DeGiay> listDeGiay = deGiayRepository.searchDeGiay(
                search1.trim(), loai1Int, pageable);
        model.addAttribute("deGiayLists", listDeGiay);
