...
public class ThuongHieuController {
    ...
    @GetMapping("view")
    public String searchThuongHieu(Model model, @RequestParam(defaultValue = "") String search1
        ...
        Page<ThuongHieu> listThuongHieu = thuongHieuRepository.searchThuongHieu(
                search1.trim(), loai1Int, pageable);
        model.addAttribute("thuongHieuLists", listThuongHieu);
