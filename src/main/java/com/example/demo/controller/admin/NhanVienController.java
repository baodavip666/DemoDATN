...
//            @RequestParam(value = "trangThai") String trangThai,
            @RequestParam(value = "vaiTro", required = false, defaultValue = "NHANVIEN") String vaiTro,
            @RequestParam(value = "nguoiTao", required = false, defaultValue = "ADMIN") String nguoiTao,
            @RequestParam("files") MultipartFile[] files) throws MessagingException {
        ...
        try {
            ...
            if (age < 15) {
                ...
                return "admin/nhan-vien/viewAddNhanVien"; // Trả về view hiện tại hoặc trang hiển thị lỗi
            }
...
//                         @RequestParam(value = "vaiTro", required = false, defaultValue = "Nhân Viên Bán Hàng") String vaiTro,
        ...
        try {
            ...
            if (age < 15) {
                model.addAttribute("errorngaySinh", "Bạn phải ít nhất 15 tuổi để đăng ký");
                return "admin/khach-hang/updateNhanVien"; // Trả về view hiện tại hoặc trang hiển thị lỗi
            }
