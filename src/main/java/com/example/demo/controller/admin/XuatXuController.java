...
public class XuatXuController {
    ...
    @GetMapping("view")
    public String searchXuatXu(Model model, @RequestParam(defaultValue = "") String search1
        ...
        Page<XuatXu> listXuatXu = xuatXuRepository.searchXuatXu(
                search1.trim(), loai1Int, pageable);
        model.addAttribute("xuatXuLists", listXuatXu);
