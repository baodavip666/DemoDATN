...
public interface SanPhamService {
    ...
    String create(@Valid SanPham sanPham, BindingResult bindingResult, @RequestParam("selectedColors") List<String> selectedColors,
                  @RequestParam("selectedSizes") List<String> selectedSizes  , @RequestParam("xuatXu") Integer xuatXu,
                  @RequestParam("nhaSanXuat") Integer nhaSanXuat, Model model);
    ...
    String delete(int id, RedirectAttributes redirectAttributes);
