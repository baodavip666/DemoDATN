...
//    }
    ...
    @Override
    public Page<PhieuGiamGia> filterPGG(java.sql.Date tuNgay, java.sql.Date denNgay, Integer kieu, Integer loai, String trangThai, String magg, Pageable pageable) {
        Page<PhieuGiamGia> phieuGiamGiaPage = phieuGiamGiaRepository.searchPGG(tuNgay, denNgay, kieu, loai, trangThai, magg, pageable);
