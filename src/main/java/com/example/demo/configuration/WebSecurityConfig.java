...
//                        .requestMatchers("/admin/san-pham/view", "/admin/phieu-giam-gia/hien-thi","/admin/khachhang/**","/admin/ban-hang/**","admin/thong-ke/view").hasAnyAuthority("ROLE_EMPLOYEE", "ROLE_ADMIN")
                                .requestMatchers("/admin/ban-hang/view",
                                        "/admin/khachhang/**",
                                        "/admin/ban-hang/**","/admin/hoadon/**","/admin/provinces","/admin/districts","/admin/wards").hasAnyAuthority("ROLE_EMPLOYEE", "ROLE_ADMIN")
                ...
                .logout(logout -> logout
                        ...
                        .logoutSuccessUrl("/user/home")  // Chuyển hướng sau khi logout thành công
