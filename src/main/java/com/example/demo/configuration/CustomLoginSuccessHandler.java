    ...
    public void onAuthenticationSuccess(HttpServletRequest request,
        ...
        if (nhanVien.isPresent()) {
            ...
            if (nv.getVaiTro().equals("ROLE_ADMIN")) {
                ...
                request.getSession().setAttribute("idNhanVien", nv.getId());
                ...
                response.sendRedirect("/admin/ban-hang/view");
            }
        } else if (khachHang.isPresent()) {
            request.getSession().setAttribute("username", khachHang.get().getTen());
            request.getSession().setAttribute("idKhachHang", khachHang.get().getId());
